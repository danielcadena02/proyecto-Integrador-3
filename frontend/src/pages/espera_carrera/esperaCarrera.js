            ...
            <div className="col-md-6">
              <div className="card-dark" id="card">
                ...
                <div className="card-body" id="card-body">
                  <img src="../imagenes/opcion de carro.png" className="mb-3" alt="" width="200px" /><img src="../imagenes/opcion de carro.png" className="mb-3" alt="" width="200px" /><img src="../imagenes/opcion de carro.png" className="mb-3" alt="" width="200px" /><table>
                    <tbody><tr>
                      </tr>
                      <tr>
                      </tr>
                  ...
                  <a href="../espera_carrera/espera_carrera.html">
